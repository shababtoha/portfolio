  ...
  const achievements = [
    {
      ...
      details: [
        'Regular practice maintaining problem-solving sharpness',
        'Focus on medium-hard problems and system design',
        'Top performer in efficiency and clean code',
      ],
    },
    {
      icon: Award,
      title: 'ACM ICPC',
      stat: 'Regional Competitor',
      description: 'Competed at university level programming contests',
      details: [
        'Team-based competitive programming experience',
        'Pressure-tested algorithmic thinking under time constraints',
        'Built skills in quick problem decomposition and optimization',
      ],
    },
    {
      icon: Code2,
      title: 'Online Judges',
      stat: 'Multi-Platform',
      description: 'Active on Codeforces, UVa, and other platforms',
      details: [
        'Diverse problem sets covering all algorithm domains',
        'Graph theory, dynamic programming, greedy algorithms',
        'Strong debugging and edge case handling skills',
      ],
    },
  ];
